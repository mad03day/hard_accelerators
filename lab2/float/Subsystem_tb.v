// -------------------------------------------------------------
// 
// File Name: D:\Short\ApaSpeed\Laba2\hdl_float\model_float\Subsystem_tb.v
// Created: 2022-12-25 04:22:04
// 
...
module Subsystem_tb;
  ...
  wire [6:0] ComplexValFloat_addr_delay;  // ufix7
  reg  tb_enb_delay;
  ...
  always @(ComplexValFloat_addr_delay, rdEnb, tb_enb_delay)
    begin
  ...
  // holdData reg for ComplexValFloat
  always @(posedge i_CLK or negedge i_RST_N)
    begin : stimuli_ComplexValFloat
      if (!i_RST_N) begin
  ...
  always @(rawData_i_COMPLEX_VALUE_im or rdEnb)
    begin : stimuli_ComplexValFloat_1
      if (rdEnb == 1'b0) begin
  ...
  assign #1 ComplexValFloat_addr_delay = Constant_out1_addr;
  ...
  // holdData reg for ComplexValFloat
  always @(posedge i_CLK or negedge i_RST_N)
    begin : stimuli_ComplexValFloat_2
      if (!i_RST_N) begin
  ...
  always @(rawData_i_COMPLEX_VALUE_re or rdEnb)
    begin : stimuli_ComplexValFloat_3
      if (rdEnb == 1'b0) begin
